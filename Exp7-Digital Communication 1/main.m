...
%     sigma=0.1;
    ...
    for ipacket=1:number_of_packets
        ...
        %=======================================================================
        % AWGN
        R_noise = normrnd(0,sigma,length(symbols_packet_tx),1);
        I_noise = j*normrnd(0,sigma,length(symbols_packet_tx),1);
        symbols_packet_tx = symbols_packet_tx+ R_noise+I_noise;
        %=======================================================================
